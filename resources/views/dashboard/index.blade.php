...
@section('content')
    <div class="home-banner text-white mb-4">
        <div class="container-fluid page__container">
            <h1 class="display-4 bold aos-init aos-animate" data-aos="fade-up" data-aos-duration="800">Everything you need to
                LEARN</h1>
            <p class="lead mb-5 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000">Get your first Job as a UI/UX
                Designer</p>
    ...
    <h2 style="margin-top: 6rem;" class="bold m-4 text-center p-4">Recent Courses</h2>
    <div class="row">
                ...
                <div class="card card__course" data-aos="fade-up" data-offset="-100">
                    <div class="card-header card-header-large card-header-dark bg-dark d-flex justify-content-center">
                        <a class="card-header__title  justify-content-center align-self-center d-flex flex-column"
                            href="#">
                            <span><img src="{{ asset('storage/courses/' . $course->image) }}" class="mb-1"
                                    style="width:70%;" alt="{{ $course->name }}"></span>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            @if (Auth::user())
                                @if (auth()->user()->courses->contains($course))
                                    <a href="{{ route('user.course.showCourse', $course->id) }}"
                                        class="btn btn-primary ml-auto">Continue</a>
                                @else
                                    <form action="{{ route('course_enroll', $course->id) }}" method="post">
                                        @csrf
                                        <button type="submit" class="btn btn-success ml-auto">Enroll</button>
                                    </form>
                                @endif
                            @else
                                <a href="{{ route('login') }}"class="btn btn-primary ml-auto">Continue</a>
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <div class="row p-4">
            <div class="col-md-6 offset-md-3">
                ...
                <div class="d-flex">
                    ...
                    <a href="#" class="btn btn-secondary ml-2" data-aos="flip-left" data-aos-duration="800"
                        data-aos-delay="150">SUBSCRIBE</a>
                </div>
            </div>
        </div>
    </div>
