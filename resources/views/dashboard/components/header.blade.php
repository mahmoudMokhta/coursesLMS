<div class="mdk-header__content">
    <div class="navbar navbar-expand-sm navbar-main navbar-dark bg-primary pl-md-0 pr-0 mdk-header--fixed fixed-top"
        id="navbar" data-primary="data-primary">
        <div class="container-fluid pr-0">

            <div class="navbar navbar-expand-sm navbar-main navbar-dark bg-primary w-100 pl-md-0 pr-0" id="navbar"
                data-primary>
                <div class="container-fluid   ">
                    <div class="d-flex sidebar-account flex-shrink-0 mr-auto">
                        <a href="{{ route('user.course') }}" class="flex d-flex align-items-center text-underline-0">
                    ...
                    @if (Auth::user())
                        <div class="dropdown ml-auto">
                            <a href="#account_menu"
                                ...
                                <img src="{{ asset('download.jpeg') }}" class="rounded-circle" width="32"
                                    alt="Frontted">
